                        ...
                        <div class="row g-4" style="padding: 0 25px 25px 25px;">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel-content">
                                    ...
                                    <div class="data-row"><i class='bx bx-target-lock'></i> <span class="lbl">SELECTION</span> <span class="val" style="word-break: break-word; white-space: normal; height: auto; color: #3b82f6;">${data.tbl_selection || '-'}</span></div>
                                    <div class="data-row"><i class='bx bx-list-ol'></i> <span class="lbl">BET TYPE</span> <span class="val" style="font-weight: 700; color: ${data.tbl_bet_type === 'Lay' ? '#ef4444' : '#3b82f6'};">${data.tbl_bet_type || 'Back'}</span></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel-content bg-panel">
                                    <div class="data-row border-b"><i class='bx bx-target-lock'></i> <span class="lbl">CHOICE / SELECTION</span> <span class="val" style="word-break: break-word; white-space: normal; height: auto; color: #3b82f6;">${data.tbl_selection || '-'}</span></div>
                                    <div class="data-row border-b"><i class='bx bx-list-ol'></i> <span class="lbl">BET TYPE</span> <span class="val" style="font-weight: 700; color: ${data.tbl_bet_type === 'Lay' ? '#ef4444' : '#3b82f6'};">${data.tbl_bet_type || 'Back'}</span></div>
